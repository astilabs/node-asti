...
var AstiError = function(message, type, details, cause) {
...
util.inherits(AstiError, Error);
AstiError.prototype.name = 'AstiError';
AstiError.prototype.toObject = function() {
  var rval = {
  ...
  if(this.cause) {
    if(this.cause instanceof AstiError) {
